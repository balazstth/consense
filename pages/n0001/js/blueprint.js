...
function handleArticleEvent(params)
{
    ...
    switch (params.article) {
        case "intro":
            redSandGenericLoader.load("pages/n0001/articles/eng/Intro.txt", contentRenderer);
            break;
        case "changelog":
        ...
        case "todo":
            ...
            break;
        case "tests":
            redSandGenericLoader.load("pages/n0001/articles/eng/Tests.txt", contentRenderer);
            break;
        case "contact":
            redSandGenericLoader.load("pages/n0001/articles/eng/Contact.txt", contentRenderer);
            break;
        default:
            redSandGenericLoader.load("pages/n0001/articles/eng/404.txt", contentRenderer);
            break;
    }
}
